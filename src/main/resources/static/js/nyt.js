...
// retrieveNYTBookInfo saves info from the NYT api,
// saves the info as book objects and then stores those objects into the booksList array.
// displayBestSellers is called
...
// This loops through the booksList and creates a card for each book object using displayBookCard.
// During each iteration, the "card" gets added to the appropriate variable, depending on the listName (using a switch case for conditional).
// Once the loop is complete, each variable gets added to it's corresponding div class.
